---
title: "MachineLearning-PredictionAssignment"
author: "gonzalezjuand"
date: "October 21, 2017"
output: html_document
---

The data was download on my Windows PC and then I used them with RStudio and Visual Studio Code
...
Let's check if there are missing data in the dataset
```{r}
